...
**247 downloads and 93 data files are still missing.** They are listed with author, version and file size in [WANTED.md](WANTED.md), together with 416 archived files from the old webhost that nobody has been able to identify yet.
